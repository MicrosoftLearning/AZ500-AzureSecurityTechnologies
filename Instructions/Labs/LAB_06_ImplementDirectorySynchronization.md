...
1. On the **Edit parameters** blade, click **Load file**, in the **Open** dialog box, click **\\\\AZ303\\AllFiles\Labs\\10\\azuredeploy30310rga.parameters.json**, click **Open**, and then click **Save**. 
